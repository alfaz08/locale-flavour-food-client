...
const SnacksProducts = () => {
 ...
 <div className="hero rounded-xl" style={{backgroundImage: 'url(https://i.ibb.co/6y1pQ2j/header-bg.png)'}}>
   ...
   <div className=" text-lg  breadcrumbs text-black">
       <h2 className="text-4xl font-bold p-6">Snacks</h2>
   <ul>
     <li><a className="text-black p-4">Home</a></li> 
     <li><a className="text-black ">All Snack Products</a></li> 
   </ul>
 </div>
   </div>
 ...
 <div className="flex justify-between bg-red-300">
   <div>
   <h2 className="text-xl font-bold mt-4">We found {allSnack.length} items for you!</h2>
 ...
 <h2 className="text-xl font-bold mt-4">Search</h2>
      ...
      {
       allSnack?.map(item=> <SingleSnackProducts key={item._id} item={item}></SingleSnackProducts>
         )
      }
      </div>
