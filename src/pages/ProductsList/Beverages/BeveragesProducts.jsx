...
const BeveragesProducts = () => {
  ...
  return (
    ...
    <Helmet>
         <title>Locale Food | Beverages Products</title>
       </Helmet>
 <div className="hero rounded-xl" style={{backgroundImage: 'url(https://i.ibb.co/6y1pQ2j/header-bg.png)'}}>
   ...
   <ul>
     ...
     <li><a className="text-black ">All Beverages Products</a></li> 
   </ul>
 </div>
   </div>
 ...
 <div className="flex justify-between bg-red-300">
   <div>
   <h2 className="text-xl font-bold mt-4">We found {allBeverages.length} items for you!</h2>
 ...
 <h2 className="text-xl font-bold mt-4">Search</h2>
      ...
      {
       allBeverages?.map(item=> <SingleBeveragesProduct key={item._id} item={item}></SingleBeveragesProduct>
         )
      }
      </div>
