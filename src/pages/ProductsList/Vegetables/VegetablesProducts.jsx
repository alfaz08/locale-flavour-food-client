...
const VegetablesProducts = () => {
  ...
  const handleSort = (event) => {
    ...
    const sortedData = allVegetables.slice().sort((a, b) => {
          ...
          <div className="grid justify-start ">
            <div className=" text-lg  breadcrumbs text-black">
              ...
              <ul>
                ...
                <li>
                  <a className="text-black ">All Vegetables Products</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="flex justify-between bg-green-100 rounded-lg">
        <div>
          <h2 className="text-xl font-bold mt-4 ml-4">
            We found {allVegetables.length} items for you!
          </h2>
        </div>
